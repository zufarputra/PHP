...
<div class="form-group">
    <form action="" method="post">
        ...
        <div class="form-group w-50">
            ...
            <input type="text" name="alamat" required placeholder="Isi Alamat Anda" class="form-control">
        </div>
        <div class="form-group w-50">
...
if (isset($_POST['simpan'])) {
    ...
    if ($password === $konfirmasi) {
        ...
        echo "<h2>Password Tidak Sama Dengan Konfirmasi Password</h2>";
    }
}
